    ...
    @if($fullArticle)
        <div class="py-4">
            ...
            @if($showReadLaterButton && ! $showRemove)
                <div class="mb-3">
                    @if($readingLater)
                        <button type="button" class="btn btn-primary btn-sm" wire:click.prevent="removeReadLater">
                    ...
                    @else
                        <button type="button" class="btn btn-outline-dark btn-sm" wire:click.prevent="readLater">
